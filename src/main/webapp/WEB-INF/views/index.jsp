            ...
            <form ng-submit="ctrl.submit()" name="myForm" class="form-horizontal">
                ...
                <div class="row">
                    <div class="form-group col-md-12">
                        ...
                        <div class="col-md-7">
                            <input type="text" ng-model="ctrl.user.password" id="password" class="username form-control input-sm" placeholder="Password" required ng-minlength="6"/>
                            <div class="has-error" ng-show="myForm.$dirty">
...
<script src="<c:url value='/static/js/controllers/user_controller.js' />"></script>
</body>
</html>